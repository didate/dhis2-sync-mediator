...
func DataValueSetToMeasureReport(dvs *dhis2.DataValueSet, dhis2BaseURL string) (*MeasureReport, error) {
...
func MeasureReportToDataValueSet(mr *MeasureReport) (*dhis2.DataValueSet, error) {
